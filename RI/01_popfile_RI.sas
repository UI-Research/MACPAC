...
%let outdata=temp_personlevel; /*final data table for this step*/
...
proc sql;
	drop table &outdata.space.personlevel;
quit;
*/
...
proc sql;
	create table unformatted_dropped_&space_name. as
	select a.*
...
proc freq data=unformatted_dropped_&space_name.;
...
data basic_recode;
	format county_miss $3. zip_miss 5. calc_date mmddyy8. EL_PHP_MO_1-EL_PHP_MO_12 1.;
	set limit_incoming_dat;

	/*trying out new MC enrollment definition*/
	if EL_PHP_TYPE_1_1 = "1" or EL_PHP_TYPE_2_1 = "1" or EL_PHP_TYPE_3_1 = "1" or EL_PHP_TYPE_4_1 = "1" then EL_PHP_MO_1 = 1;
	else EL_PHP_MO_1 = 0;
	if EL_PHP_TYPE_1_2 = "1" or EL_PHP_TYPE_2_2 = "1" or EL_PHP_TYPE_3_2 = "1" or EL_PHP_TYPE_4_2 = "1" then EL_PHP_MO_2 = 1;
	else EL_PHP_MO_2 = 0;
	if EL_PHP_TYPE_1_3 = "1" or EL_PHP_TYPE_2_3 = "1" or EL_PHP_TYPE_3_3 = "1" or EL_PHP_TYPE_4_3 = "1" then EL_PHP_MO_3 = 1;
	else EL_PHP_MO_3 = 0;
	if EL_PHP_TYPE_1_4 = "1" or EL_PHP_TYPE_2_4 = "1" or EL_PHP_TYPE_3_4 = "1" or EL_PHP_TYPE_4_4 = "1" then EL_PHP_MO_4 = 1;
	else EL_PHP_MO_4 = 0;
	if EL_PHP_TYPE_1_5 = "1" or EL_PHP_TYPE_2_5 = "1" or EL_PHP_TYPE_3_5 = "1" or EL_PHP_TYPE_4_5 = "1" then EL_PHP_MO_5 = 1;
	else EL_PHP_MO_5 = 0;
	if EL_PHP_TYPE_1_6 = "1" or EL_PHP_TYPE_2_6 = "1" or EL_PHP_TYPE_3_6 = "1" or EL_PHP_TYPE_4_6 = "1" then EL_PHP_MO_6 = 1;
	else EL_PHP_MO_6 = 0;
	if EL_PHP_TYPE_1_7 = "1" or EL_PHP_TYPE_2_7 = "1" or EL_PHP_TYPE_3_7 = "1" or EL_PHP_TYPE_4_7 = "1" then EL_PHP_MO_7 = 1;
	else EL_PHP_MO_7 = 0;
	if EL_PHP_TYPE_1_8 = "1" or EL_PHP_TYPE_2_8 = "1" or EL_PHP_TYPE_3_8 = "1" or EL_PHP_TYPE_4_8 = "1" then EL_PHP_MO_8 = 1;
	else EL_PHP_MO_8 = 0;
	if EL_PHP_TYPE_1_9 = "1" or EL_PHP_TYPE_2_9 = "1" or EL_PHP_TYPE_3_9 = "1" or EL_PHP_TYPE_4_9 = "1" then EL_PHP_MO_9 = 1;
	else EL_PHP_MO_9 = 0;
	if EL_PHP_TYPE_1_10 = "1" or EL_PHP_TYPE_2_10 = "1" or EL_PHP_TYPE_3_10 = "1" or EL_PHP_TYPE_4_10 = "1" then EL_PHP_MO_10 = 1;
	else EL_PHP_MO_10 = 0;
	if EL_PHP_TYPE_1_11 = "1" or EL_PHP_TYPE_2_11 = "1" or EL_PHP_TYPE_3_11 = "1" or EL_PHP_TYPE_4_11 = "1" then EL_PHP_MO_11 = 1;
	else EL_PHP_MO_11 = 0;
	if EL_PHP_TYPE_1_12 = "1" or EL_PHP_TYPE_2_12 = "1" or EL_PHP_TYPE_3_12 = "1" or EL_PHP_TYPE_4_12 = "1" then EL_PHP_MO_12 = 1;
	else EL_PHP_MO_12 = 0;

	/*get bene restr bnft flag for most recent non-zero, non-null flag*/
	if EL_RSTRCT_BNFT_FLG_12 ne "0" and EL_RSTRCT_BNFT_FLG_12 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_12; 
	else if EL_RSTRCT_BNFT_FLG_11 ne "0" and EL_RSTRCT_BNFT_FLG_11 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_11; 
	else if EL_RSTRCT_BNFT_FLG_10 ne "0" and EL_RSTRCT_BNFT_FLG_10 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_10; 
	else if EL_RSTRCT_BNFT_FLG_9 ne "0" and EL_RSTRCT_BNFT_FLG_9 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_9; 
	else if EL_RSTRCT_BNFT_FLG_8 ne "0" and EL_RSTRCT_BNFT_FLG_8 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_8; 
	else if EL_RSTRCT_BNFT_FLG_7 ne "0" and EL_RSTRCT_BNFT_FLG_7 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_7; 
	else if EL_RSTRCT_BNFT_FLG_6 ne "0" and EL_RSTRCT_BNFT_FLG_6 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_6; 
	else if EL_RSTRCT_BNFT_FLG_5 ne "0" and EL_RSTRCT_BNFT_FLG_5 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_5;
	else if EL_RSTRCT_BNFT_FLG_4 ne "0" and EL_RSTRCT_BNFT_FLG_4 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_4; 
	else if EL_RSTRCT_BNFT_FLG_3 ne "0" and EL_RSTRCT_BNFT_FLG_3 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_3;
	else if EL_RSTRCT_BNFT_FLG_2 ne "0" and EL_RSTRCT_BNFT_FLG_2 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_2;
	else if EL_RSTRCT_BNFT_FLG_1 ne "0" and EL_RSTRCT_BNFT_FLG_1 ne "" then EL_RSTRCT_BNFT_FLG_LTST = EL_RSTRCT_BNFT_FLG_1;
	else EL_RSTRCT_BNFT_FLG_LTST = "";

	/*count how many benes had partial benefits in every month*/
	if EL_RSTRCT_BNFT_FLG_12 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_12 = 1;
	if EL_RSTRCT_BNFT_FLG_12 = "0" then partial_benefits_12 = .;
	if EL_RSTRCT_BNFT_FLG_12 = "1" then partial_benefits_12 = 0;
	if EL_RSTRCT_BNFT_FLG_11 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_11 = 1;
	if EL_RSTRCT_BNFT_FLG_11 = "0" then partial_benefits_11 = .;
	if EL_RSTRCT_BNFT_FLG_11 = "1" then partial_benefits_11 = 0;
	if EL_RSTRCT_BNFT_FLG_10 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_10 = 1;
	if EL_RSTRCT_BNFT_FLG_10 = "0" then partial_benefits_10 = .;
	if EL_RSTRCT_BNFT_FLG_10 = "1" then partial_benefits_10 = 0;
	if EL_RSTRCT_BNFT_FLG_9 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_9 = 1;
	if EL_RSTRCT_BNFT_FLG_9 = "0" then partial_benefits_9 = .;
	if EL_RSTRCT_BNFT_FLG_9 = "1" then partial_benefits_9 = 0;
	if EL_RSTRCT_BNFT_FLG_8 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_8 = 1;
	if EL_RSTRCT_BNFT_FLG_8 = "0" then partial_benefits_8 = .;
	if EL_RSTRCT_BNFT_FLG_8 = "1" then partial_benefits_8 = 0;
	if EL_RSTRCT_BNFT_FLG_7 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_7 = 1;
	if EL_RSTRCT_BNFT_FLG_7 = "0" then partial_benefits_7 = .;
	if EL_RSTRCT_BNFT_FLG_7 = "1" then partial_benefits_7 = 0;
	if EL_RSTRCT_BNFT_FLG_6 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_6 = 1;
	if EL_RSTRCT_BNFT_FLG_6 = "0" then partial_benefits_6 = .;
	if EL_RSTRCT_BNFT_FLG_6 = "1" then partial_benefits_6 = 0;
	if EL_RSTRCT_BNFT_FLG_5 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_5 = 1;
	if EL_RSTRCT_BNFT_FLG_5 = "0" then partial_benefits_5 = .;
	if EL_RSTRCT_BNFT_FLG_5 = "1" then partial_benefits_5 = 0;
	if EL_RSTRCT_BNFT_FLG_4 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_4 = 1;
	if EL_RSTRCT_BNFT_FLG_4 = "0" then partial_benefits_4 = .;
	if EL_RSTRCT_BNFT_FLG_4 = "1" then partial_benefits_4 = 0;
	if EL_RSTRCT_BNFT_FLG_3 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_3 = 1;
	if EL_RSTRCT_BNFT_FLG_3 = "0" then partial_benefits_3 = .;
	if EL_RSTRCT_BNFT_FLG_3 = "1" then partial_benefits_3 = 0;
	if EL_RSTRCT_BNFT_FLG_2 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_2 = 1;
	if EL_RSTRCT_BNFT_FLG_2 = "0" then partial_benefits_2 = .;
	if EL_RSTRCT_BNFT_FLG_2 = "1" then partial_benefits_2 = 0;
	if EL_RSTRCT_BNFT_FLG_1 in ("2", "3", "4", "5", "6", "W", "Y", "Z") then partial_benefits_1 = 1;
	if EL_RSTRCT_BNFT_FLG_1 = "0" then partial_benefits_1 = .;
	if EL_RSTRCT_BNFT_FLG_1 = "1" then partial_benefits_1 = 0;

	partial_benf_mon = sum(of partial_benefits_:);
	/***********************************/
	...
	*RI correction;
	if state_cd = 'RI' and EL_RSDNC_CNTY_CD_LTST in('000','999',' ') then EL_RSDNC_CNTY_CD_LTST = "005";
...
quit;
%mend;
/*managed care dummies*/
%let mc_dum=;
	%dum_var(indata=basic_recode,
	month_var=EL_PHP_MO_,
	condition_one="= 1",
	condition_zero="= 0",
	dum_var_pref=mc_,
...
%macro create_cell_cat(month_suff=);
	case 
...
proc sql;
	create table make_cellmonths as 
	select *, 
		%create_cell_cat(month_suff=_1),
		%create_cell_cat(month_suff=_2),
		%create_cell_cat(month_suff=_3),
		%create_cell_cat(month_suff=_4),
		%create_cell_cat(month_suff=_5),
		%create_cell_cat(month_suff=_6),
		%create_cell_cat(month_suff=_7),
		%create_cell_cat(month_suff=_8),
		%create_cell_cat(month_suff=_9),
		%create_cell_cat(month_suff=10),
		%create_cell_cat(month_suff=11),
		%create_cell_cat(month_suff=12)
	from make_dumvars;
quit;
...
%let count_01=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('01')",macro_var_name=count_01);
%let count_02=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('02')",macro_var_name=count_02);
%let count_03=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('03')",macro_var_name=count_03);
%let count_04=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('04')",macro_var_name=count_04);
%let count_05=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('05')",macro_var_name=count_05);
%let count_06=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('06')",macro_var_name=count_06); 
%let count_07=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('07')",macro_var_name=count_07);
%let count_08=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('08')",macro_var_name=count_08);
%let count_09=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('09')",macro_var_name=count_09);
%let count_10=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('10')",macro_var_name=count_10);
%let count_11=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('11')",macro_var_name=count_11);
%let count_12=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('12')",macro_var_name=count_12);
%let count_13=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('13')",macro_var_name=count_13);
%let count_14=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('14')",macro_var_name=count_14);
%let count_15=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('15')",macro_var_name=count_15);
%let count_16=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('16')",macro_var_name=count_16);
%let count_17=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('17')",macro_var_name=count_17);
%let count_mcd_only=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('01','02','03','04','05','06','07','08')",macro_var_name=count_mcd_only);
%let count_dual_only=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('09','10','11','12','13','14','15','16')",macro_var_name=count_dual_only);
%let count_mc_only=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('01','02','03','04','09','10','11','12')",macro_var_name=count_mc_only);
%let count_ffs_only=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('05','06','07','08','13','14','15','16')",macro_var_name=count_ffs_only);
%let count_dsbl=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('01','02','05','06','09','10','13','14')",macro_var_name=count_dsbl);
%let count_nondsbl=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('03','04','07','08','11','12','15','16')",macro_var_name=count_nondsbl);
%let count_ltss=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('01','03','05','07','09','11','13','15')",macro_var_name=count_ltss);
%let count_nonltss=;%count_var(indata=make_cellmonths,month_var=servicetype,condition_one="in ('02','04','06','08','10','12','14','16')",macro_var_name=count_nonltss);

proc sql;
create table count_cellmonths as
select *,
...
from make_cellmonths;
quit;

data &outdata.;
set count_cellmonths;
length age_cell $16.;
	...
	cell = latest_servicetype;

	if age_cat=1 and not missing(latest_servicetype) then age_cell = catx('_','child',latest_servicetype); 
	else if age_cat=2 and not missing(latest_servicetype) then age_cell = catx('_','adult',latest_servicetype); 
	else if age_cat=3 and not missing(latest_servicetype) then age_cell = catx('_','senior',latest_servicetype);
	...
	label 	
		...
		age_cell = "Cell and age category"
