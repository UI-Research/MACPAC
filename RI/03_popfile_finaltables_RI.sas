...
%let indata=temp_personlevel_geofixed;
%let personlevel=temp_personlevel;
%let outdata=id_pop;
...
/*
proc sql;
	drop table &personlevel.,  &outdata.,  &outdata._dropped ;
quit;
*/
...
proc sql noprint;
	...
	where libname=upcase("work") and memname like upcase('%personlevel_geofixed%') and name like "servicetype_%";
quit;
proc sql;
