...
/*export a stata copy;
proc export data=&msa.
  outfile= "P:\MCD-SPVR\data\workspace\output\msa_2012_&space_name..dta" replace;
run;

proc export data=&hrr.
  outfile= "P:\MCD-SPVR\data\workspace\output\hrr_2012_&space_name..dta" replace;
run;
*/
