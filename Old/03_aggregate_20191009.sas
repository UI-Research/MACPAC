...
proc freq data=&indata_max.;tables full_benf;run;
...
%macro collapse (indata,collapse_on,outdata);
	proc sql;
		create table &outdata. as
			...
			sum(case when partial_benefits_1=1 then 1 else 0 end) as partial_benf_mon1, 
			sum(case when partial_benefits_2=1 then 1 else 0 end) as partial_benf_mon2, 
			sum(case when partial_benefits_3=1 then 1 else 0 end) as partial_benf_mon3, 
			sum(case when partial_benefits_4=1 then 1 else 0 end) as partial_benf_mon4, 
			sum(case when partial_benefits_5=1 then 1 else 0 end) as partial_benf_mon5, 
			sum(case when partial_benefits_6=1 then 1 else 0 end) as partial_benf_mon6, 
			sum(case when partial_benefits_7=1 then 1 else 0 end) as partial_benf_mon7, 
			sum(case when partial_benefits_8=1 then 1 else 0 end) as partial_benf_mon8, 
			sum(case when partial_benefits_9=1 then 1 else 0 end) as partial_benf_mon9, 
			sum(case when partial_benefits_10=1 then 1 else 0 end) as partial_benf_mon10, 
			sum(case when partial_benefits_11=1 then 1 else 0 end) as partial_benf_mon11, 
			sum(case when partial_benefits_12=1 then 1 else 0 end) as partial_benf_mon12, 
...
/******************************/
proc sql;
	create table msa_arhfvars_wageind (drop= partial_benf_mon1 partial_benf_mon2 partial_benf_mon3 partial_benf_mon4  partial_benf_mon5 partial_benf_mon6 
										partial_benf_mon7 partial_benf_mon8 partial_benf_mon9 partial_benf_mon10 partial_benf_mon11 partial_benf_mon12) as
	select msa.*, 
		sum(partial_benf_mon1,partial_benf_mon2,partial_benf_mon3,partial_benf_mon4,partial_benf_mon5,partial_benf_mon6,
			partial_benf_mon7,partial_benf_mon8,partial_benf_mon9,partial_benf_mon10,partial_benf_mon11,partial_benf_mon12) as partial_benf_mon,
		wag.WORK as wageind_WORK, wag.PE as wageind_PE, wag.MPE as wageind_MPE
