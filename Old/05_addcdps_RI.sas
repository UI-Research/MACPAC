...
%let indata = id_pop; /*input data file from 01_studypop_analyticfile*/
%let outdata=temp_max_cdpsscores;
...
proc sql;
	create table drp_benes_wofllbenf as
	select *
	from &indata.
...
proc sql;
	create table temp_max_cdpsscores as
	select *
