...
%macro prod();
	options obs=MAX;
	/*Log*/
	proc printto print="P:\MCD-SPVR\log\01_studypop_&sysdate..lst"
	               log="P:\MCD-SPVR\log\01_studypop_&sysdate..log" NEW;
	run;
%mend;
...
%make_popfile(indata=data.maxdata_ps_2012, outdata=personlevel);
