/*******************************************************************************************************************/ 
/*	Purpose: Create various MASBOE/age category aggregation levels for MSA-level CDPS flag population analytic files		
...
%let indata_max = space.max2012_cdps_subset; /*input data file with max2012 data and CDPS data*/
