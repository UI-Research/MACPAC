...
/*	Notes: 
/*		Changed definition of partial benefits 
...
data basic_recode;
	format county_miss $3. zip_miss 5. calc_date mmddyy8.;
...
from make_cellmonths (drop=cell_age);
quit;
/*macro that creates a macro variable list that contains dummy variables given a monthly input var(month_var), a valid condition (condition_one), a zero condition (condition_zero), the prefix for the dummary variables (dum_var_pref), and the macro variable name (macro_var_name)*/
%let outdata=temp_outdata;
data &outdata.;
...
length age_cell $16.;
	...
	label 	
		...
		nmcd__1 = "Not Medicaid - Jan"
		nmcd__2 = "Not Medicaid - Feb"
		nmcd__3 = "Not Medicaid - Mar"
		nmcd__4 = "Not Medicaid - Apr"
		nmcd__5 = "Not Medicaid - May"
		nmcd__6 = "Not Medicaid - Jun"
		nmcd__7 = "Not Medicaid - Jul"
		nmcd__8 = "Not Medicaid - Aug"
		nmcd__9 = "Not Medicaid - Sep"
		nmcd_10 = "Not Medicaid - Oct"
		nmcd_11 = "Not Medicaid - Nov"
		nmcd_12 = "Not Medicaid - Dec"
		...
		partial_benf_mon = "Number of Partial Benefit Months"
		;
run;

proc sql;
	select state_cd, sum(mo_mc)
	from &outdata.
	group by state_cd;
quit;
