...
%let indata=dia2l_cdps_benes; %let indata_collapsed=msa_dia2l_nomasboe_noage; %let orig_data=ahrf_aggre;%let collapsevar=st_msa;%let outdata=space.msa_dia2l_nomasboe_noage;
	proc sql;
...
proc contents data=space.msa_dia2l_nomasboe_noage;run;
/*
proc sql;
...
proc sql;
	select count(*), sum(cell_n) as sum_celln, sum(bene_count) as benes
	from space.msa_dia2l_nomasboe_noage;
quit;
proc export data=msa_dia2l_nomasboe_noage
   outfile='P:\MCD-SPVR\data\NO_PII\msa_dia2l_nomasboe_noage.csv' dbms=csv;
run;
proc export data=msa_carel_nomasboe_noage
   outfile='P:\MCD-SPVR\data\NO_PII\msa_carel_nomasboe_noage.csv' dbms=csv;
run;
proc export data=msa_canl_nomasboe_noage
   outfile='P:\MCD-SPVR\data\NO_PII\msa_canl_nomasboe_noage.csv' dbms=csv;
run;
proc export data=msa_prgcmp_nomasboe_noage
   outfile='P:\MCD-SPVR\data\NO_PII\msa_prgcmp_nomasboe_noage.csv' dbms=csv;
run;
proc export data=msa_psyl_nomasboe_noage
   outfile='P:\MCD-SPVR\data\NO_PII\msa_psyl_nomasboe_noage.csv' dbms=csv;
run;
proc export data=msa_pula_nomasboe_noage
