/*******************************************************************************************************************/ 
/*	Purpose: Pull claims with primary diagnosis for select CDPS chronic conditions subpopulations - IP and LT claims
...
proc sql;
	select count(*) as all_count,
		(select count(*) from (select distinct * from ip_bene_svcdx_svctype)) as dist_count
	from space.ip_bene_svcdx_svctype;
quit;
...
proc sql;
	select count(*) as all_count,
		(select count(*) from (select distinct * from lt_bene_svcdx_svctype)) as dist_count
	from space.lt_bene_svcdx_svctype;
quit;

proc sql;
	create table space.ip_lt_cdpsclaims_&space_name. as
	select *
...
proc sql;
	select count(*) as all_count,
		(select count(*) from (select distinct * from space.ip_lt_cdpsclaims_&space_name. )) as dist_count
	from space.ip_lt_cdpsclaims_&space_name. .;
quit;
